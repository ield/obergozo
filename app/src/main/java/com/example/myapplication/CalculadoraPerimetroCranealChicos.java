...
public class CalculadoraPerimetroCranealChicos {
    //El percentil 97 son 1.88
    private double[] edad = {0, 0.25, 0.5, 0.75, 1, 1.5, 2};
    private double[] p50 = {34.84, 41.2, 44.15, 46.02, 47.31, 48.7, 49.59};
    private double[] p97 = {37.11, 43.37, 46.3, 48.18, 49.47, 51.09, 52};
    private double percentil;

    public CalculadoraPerimetroCranealChicos(double age, double medida){
